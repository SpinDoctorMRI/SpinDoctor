function qmesh = mesh_quality(points, elements)
%MESH_QUALITY Compute mesh quality.
...
for idv = 1:4
    tetra_xyz{idv} = points(:, elements(idv, :));
end
...
% Compute InRadius based on the volume and areas of 4 facets
% Each facet area is computed by Heron's Formula
p123 = 0.5 * (l21 + l31 + l32);
p234 = 0.5 * (l32 + l42 + l43);
p341 = 0.5 * (l43 + l41 + l31);
p124 = 0.5 * (l21 + l41 + l42);
