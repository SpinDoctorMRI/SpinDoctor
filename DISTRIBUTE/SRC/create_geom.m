...
% 	[Rvec]=create_cylinders_inputfile_fixR(params_cells.ncell,params_cells.Rmin,params_cells.Rmax,...
%     params_cells.dmin,params_cells.dmax,fname_cells,params_cells.Hcyl);
    [Rvec]=create_cylinders_inputfile(params_cells.ncell,params_cells.Rmin,params_cells.Rmax,...
        params_cells.dmin,params_cells.dmax,fname_cells,params_cells.Hcyl);
    params_cells.Rvec = Rvec;
end   
