...
%% PDE parameters
setup.pde.diffusivity_in = 0.002;               % Diffusion coefficient IN (scalar or tensor)
setup.pde.diffusivity_out = 0.002;              % Diffusion coefficient OUT (scalar or tensor)
...
setup.gradient.values = [0:100:500 1000:1000:4000];     % g-, q-, or b-values [1 x namplitude]
setup.gradient.values_type = "b";                       % Type of values; "g", "q" or "b"
setup.gradient.sequences{1} = PGSE(2500, 5000);         % Gradient sequences {1 x nsequence}
setup.gradient.sequences{2} = PGSE(2500, 10000);        % Gradient sequences {1 x nsequence}
