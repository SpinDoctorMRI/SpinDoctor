...
format short
addpath params_files/params_hadc_multidir_wholeneuron
...
if (experi_common.ngdir_total == 1)    
    ...
    if (~isempty(experi_hadc))
        ...
        if(DO_PLOTS)
            ...
            for iexperi = 1:nexperi
                PLOT_HARDI_PT(points_gdir, ADC_HADC_allcmpts_alldir(:,iexperi),['HADC\_HARDI experiment', num2str(iexperi)]);
            end
        end
    end
end
