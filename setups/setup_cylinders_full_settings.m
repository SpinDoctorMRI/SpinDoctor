%SETUP_CYLINDERS_FULL_SETTINGS Define setup structure for SpinDoctor.
%
...
setup.name = "mesh_files/cylinders/cylinders_full_settings";
...
setup.geometry.deformation = [0.05; 0.0];               % Domain deformation; [a_bend,a_twist]
...
setup.gradient.directions = unitsemicircle(2);          % Gradient directions [3 x ndirection]
...
setup.mf.eigs.ssdim = 1500;                             % Maximum size of Krylov subspace
