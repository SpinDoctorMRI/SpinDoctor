...
setup.geometry.tetgen_options = "-pq1.2a1.0VCn";              % Tetgen options (priority is inferior to refinement)
...
%% Gradient sequences
setup.gradient.sequences = {PGSE(2500,5000),PGSE(2500,7500),PGSE(2500,10000)};
setup.gradient.directions = [1;0;0];
setup.gradient.values = [100];
