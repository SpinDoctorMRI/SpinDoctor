...
if ~rerun && do_save
    % Iterate over sequences, gradient amplitudes and directions
        ...
        for ia = 1:prod([namplitude, ndirection])
            ...
            if hasfield(mfile, gradient_field)
                ...
                try
                    ...
                    warning("mf: the saved data of experiment %s %s doesn't"...
                     + " exist or is broken. Rerun simulation.", ...
