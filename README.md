...
Getting started
    ...
    The DISTRIBUTE folder contains drivers for typical simulations.
    ...
    User Guide is found [here](https://github.com/jingrebeccali/SpinDoctor/blob/NeuronModule/User%20Guide.pdf)
