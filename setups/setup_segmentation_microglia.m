...
setup.name = "mesh_files/microglia/Ramified/826_5_3.ply";  % Path to surface mesh of cell.
...
%% Cell parameters
setup.cell.swc = "swc_files/826_5_3.swc";       % Path to swc file of cell
setup.cell.soma = "mesh_files/microglia/Soma/826_5_3.ply" % Path to surface mesh of soma
%% PDE parameters
