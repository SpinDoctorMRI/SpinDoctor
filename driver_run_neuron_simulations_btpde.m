...
% plot_neurite_alignment(femesh_soma,femesh_neurites_mf,inds,femesh_soma_um,femesh_neurites_btpde,inds_btpde,cellname);
% [neurite_signals_mf,neurite_signals_btpde] = merge_process_signals(results_mf,results_btpde,femesh_neurites_mf,femesh_neurites_btpde,inds,inds_btpde);
