...
%%%% Load Spindoctor simulation parameters.
...
% Figure 9
% imesh = 1; meshname_btpde{imesh} = '04b_spindle3aFI_dendrites_1';
% simul_tol{imesh} = [1e-2,1e-4]; simul_h{imesh} = -1;simul_2d{imesh}=1;
...
legend_vec{1} = 'Geometry';
legend_vec{2} = 'Simul 1, b = 1000';
legend_vec{3} = 'Simul 2, b = 1000';
legend_vec{4} = 'Simul 3, b = 1000';
legend_vec{5} = 'Simul 1, b = 4000';
legend_vec{6} = 'Simul 2, b = 4000';
legend_vec{7} = 'Simul 3, b = 4000';
