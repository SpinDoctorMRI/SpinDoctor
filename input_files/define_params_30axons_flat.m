%DEFINE_PARAMS_30AXONS_FLAT SpinDoctor input file.
...
%% Mesh file
filename = "mesh_files/cylinders/30axons_flat";
...
params_cells.("ncell") = 30;                            % Number of cells
params_cells.("rmin") = 1;                              % Minimum radius
params_cells.("rmax") = 8;                              % Maximum radius
...
experiment.("ndirection") = 64;                         % Number of gradient directions to simulate
...
experiment.("direction") = [1.0; 1.0; 1.0];             % Gradient direction; [g1; g2; g3] (if ndirection=1)
experiment.("values") = q;                              % g-, q-, or b-values [1 x namplitude]
experiment.("values_type") = "q";                       % Type of values; "g", "q" or "b"
experiment.("sequences") = sequences;                   % Gradient sequences {1 x nsequence}

%% BTPDE experiment parameters (comment block to skip experiment)
experiment.("btpde").("ode_solver") = @ode23t;          % ODE solver for BTPDE
