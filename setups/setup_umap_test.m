...
setup.geometry.tetgen_options = "-pq1.1a1.0VCn";    
...
%% Gradient sequences
setup.gradient.sequences = {PGSE(6000,40000)};
setup.gradient.directions = unitsphere(16);
setup.gradient.values = [253];
setup.gradient.values_type  = "g";
...
setup.mf.length_scale =1.0;                               % Minimum length scale of eigenfunctions
