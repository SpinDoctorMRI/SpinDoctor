...
save(sprintf('neuron_meshing_paper/neuron_output/%s_seg.mat',cellname), ...
    'signal_cell','signal_cell_um','signal_soma','signal_soma_um', ...
    'signal_neurite_compartment','signal_neurite_compartment_um', ...
    'volume_neurite_cmpt','volume_neurite_cmpt_um',...
    'signals_neurites','signals_neurites_um', ...
    'bvals','volume_soma','volume_soma_um','volumes_neurites', ...
    'volumes_neurites_um',"signal_cell","signal_cell_um",'volume','volume_um', ...
    'bvals');   
